      ...
      <table width="520" cellpadding="0" cellspacing="0" style="background:#1e293b;border-radius:16px;overflow:hidden;border:1px solid #334155;">
        <tr>
          <td style="background:#0b1628;padding:28px 36px;border-bottom:1px solid #1d4ed8;">
            <span style="font-size:22px;font-weight:700;color:#ffffff;">Leadedly</span>
          </td>
        </tr>
        <tr>
          <td style="padding:36px 36px 28px;">
            ...
            <p style="margin:0 0 28px;font-size:15px;color:#cbd5e1;line-height:1.6;">
              Welcome to Leadedly! Please verify your email address to activate your account.
            </p>
            <div style="background:#0f172a;border:1px solid #334155;border-radius:12px;padding:24px;text-align:center;margin-bottom:28px;">
              ...
              <p style="margin:0;font-size:42px;font-weight:700;color:#ffffff;letter-spacing:12px;font-family:'Courier New',monospace;">${code}</p>
            </div>
            <p style="margin:0 0 8px;font-size:13px;color:#64748b;">⏱ This code expires in <strong style="color:#94a3b8;">24 hours</strong>.</p>
          </td>
        </tr>
        <tr>
          <td style="padding:20px 36px;border-top:1px solid #1e293b;">
            <p style="margin:0;font-size:12px;color:#475569;">If you didn't create a Leadedly account, you can safely ignore this email.</p>
          </td>
        </tr>
      </table>
    </td></tr>
